...
parser.add_argument('--checkpoint', default='', type=str, metavar='PATH', help='path to latest checkpoint (default: "")')
...
def dir_main():
    ...
    for index, row in df.iterrows():
        ...
        if not os.path.isfile(full_path):
            print("\t no file at: {}".format(full_path))
            continue
        
        args.viz_output_name = row["Name"]+"_viz_results.json"
