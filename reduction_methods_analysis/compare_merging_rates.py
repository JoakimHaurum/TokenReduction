...
parser = argparse.ArgumentParser(description='Compare merging-based method(s) across keep rates')
            ...
            for img in keys_list:
                ...
                for stage in stages:
                    if stage in stages2:
                        ...
                        homogeneity, completeness, nmi = homogeneity_completeness_v_measure(cluster2, cluster1)
